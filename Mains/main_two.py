""" 
Trains U_net one with random gray
"""


from torchvision.transforms.transforms import ColorJitter, GaussianBlur, RandomGrayscale
from Data_loader import ImageDataset, Data_loader
from U_net_one import UNet
import torch
...
if __name__ == "__main__":
    ...
    #model.load_state_dict(torch.load('/home/ruben/Documents/school/Master 1/natural computing/NaturalComputing_assignments/results_project/results/models/u_net_one_gray'))


    train_transform = transforms.Compose([
        transforms.Grayscale(3),
        transforms.ColorJitter(0.5,0.7,0.8,0.5),
        transforms.GaussianBlur(kernel_size=7, sigma=(0.2,2)),
        transforms.ToTensor(),
    ...
    dataset = Data_loader(TRAIN_ANNOTATIONS_SMALL_PATH, TRAIN_IMAGES_DIRECTORY, 0.2, BATCH_SIZE, train_transform, val_transform, shuffle=True, seed=42, p=0.8)
