...
if __name__ == "__main__":
    ...
    dataset = Data_loader(TRAIN_ANNOTATIONS_SMALL_PATH, TRAIN_IMAGES_DIRECTORY, 0.2, BATCH_SIZE, train_transform, val_transform, shuffle=True, seed=42, p=0.5)
